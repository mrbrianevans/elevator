...
def baseline_mechanical(number_of_people, number_of_floors, animate: bool = True):
    ...
    # print("Average wait", average_wait_time)
...
if __name__ == "__main__":
    # naive = np.array(run_many_simulations(naive_simulation, 20, 10))
    # print(naive)
    # graph_one_simulation_frequency(baseline_mechanical, 10, 10, 100_000)
    run_many_simulations(baseline_mechanical, 25, 25)
